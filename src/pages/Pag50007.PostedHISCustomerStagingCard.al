page 50007 "3E Posted HIS Customer Card"
{
    ...
    layout
    {
        area(content)
        {
            ...
            group("Statutory Details")
            {
                ...
                {
                    ApplicationArea = All;
                    ToolTip = 'Specifies the registration number of the Customers. You can enter a maximum of 20 characters, both numbers and letters.';
                }
            }
