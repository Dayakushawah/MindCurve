tableextension 50008 "3E HIS Sales Header" extends "Sales Header"
{
    fields
    {
        ...
        field(50006; "3E Encounter No."; Code[50])
        {
            DataClassification = CustomerContent;
            Caption = 'Encounter No.';
        }
        field(50007; "3E Doctor Name"; Text[100])
        {
            DataClassification = CustomerContent;
            Caption = 'Doctor Name';
        }
        ...
        field(50010; "3E Sponsor Name"; Text[100])
        {
            DataClassification = CustomerContent;
        ...
        field(50015; "Order Amount"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(50016; "Integration PO Created"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(50017; "Indent Order"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(50018; "Amount to Customer"; Decimal)
        {
