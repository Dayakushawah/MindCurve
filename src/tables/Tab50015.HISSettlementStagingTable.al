table 50015 "3E HIS Settlement Staging"
{
    ...
    fields
    {
        ...
        field(38; TRANSACTION_TYPE; Text[50])
        {
            Caption = 'TRANSACTION_TYPE';
            DataClassification = CustomerContent;
        }
        field(39; "Encounter No."; Code[20])
        {
            DataClassification = CustomerContent;
            Caption = 'Encounter No.';
        }
        field(40; "HIS User ID"; Text[50])
        {
            DataClassification = CustomerContent;
            Caption = 'HIS User ID';
        }
        field(41; "HIS User Name"; Text[50])
        {
            DataClassification = CustomerContent;
            Caption = 'HIS User Name';
        }
        field(42; "Mode of Payment"; Text[20])
        {
            DataClassification = CustomerContent;
            Caption = 'Mode of Payment';
        }
        field(43; "Sponsor Code"; Code[20])
        {
            DataClassification = CustomerContent;
            Caption = 'Sponsor Code';
        }
        field(44; "Sponsor Name"; Text[50])
        {
            DataClassification = CustomerContent;
            Caption = 'Sponsor Name';
        }
        field(45; "Payer Code"; Code[16])
        {
            DataClassification = CustomerContent;
            Caption = 'Payer Code';
        }
        field(46; "Payer Name"; Text[100])
        {
            DataClassification = CustomerContent;
            Caption = 'Payer Name';
        }
        field(47; "Payor Category"; Text[50])
        {
            DataClassification = CustomerContent;
            Caption = 'Payor Category';
        }

        field(48; "IP No."; Code[20])
        {
            DataClassification = CustomerContent;
            Caption = 'IP No.';
        }
        field(49; "Credit Type"; Option)
        {
            Caption = 'Credit Type';
            OptionMembers = Payer,Payee;
            DataClassification = CustomerContent;
        }
        field(50; "SettlementType"; Option)
        {
